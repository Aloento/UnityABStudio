namespace SoarCraft.QYun.AssetReader.Math {
    ...
    public struct Matrix4x4 : IEquatable<Matrix4x4> {
            ...
            set {
                switch (index) {
                    ...
                    case 15:
                        ...
                        break;
                    default:
                        throw new ArgumentOutOfRangeException(nameof(index), "Invalid Matrix4x4 index!");
                }
            }
        }
        ...
        public Vector4 GetColumn(int index) => index switch {
            0 => new Vector4(this.M00, this.M10, this.M20, this.M30),
            1 => new Vector4(this.M01, this.M11, this.M21, this.M31),
            2 => new Vector4(this.M02, this.M12, this.M22, this.M32),
            3 => new Vector4(this.M03, this.M13, this.M23, this.M33),
            _ => throw new IndexOutOfRangeException("Invalid column index!"),
        };

        public Vector4 GetRow(int index) => index switch {
            0 => new Vector4(this.M00, this.M01, this.M02, this.M03),
            1 => new Vector4(this.M10, this.M11, this.M12, this.M13),
            2 => new Vector4(this.M20, this.M21, this.M22, this.M23),
            3 => new Vector4(this.M30, this.M31, this.M32, this.M33),
