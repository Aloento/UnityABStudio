...
namespace SoarCraft.QYun.AssetReader._7zip.Compress.LZMA {
    ...
    public class Encoder : ICoder, ISetCoderProperties, IWriteCoderProperties {
                    ...
                    if (lenTest < numAvailableBytesFull) {
                        ...
                        if (lenTest2 >= 2) {
                            ...
                            var curAndLenCharPrice =
                                    ...
                                    this._matchFinder.GetIndexByte((Int32)((Int32)lenTest - 1 - (Int32)(this.reps[repIndex] + 1))),
        ...
        void SetOutStream(System.IO.Stream outStream) { this._rangeEncoder.SetStream(outStream); }
                ...
                switch (propIDs[i]) {
                    ...
                    case CoderPropID.PosStateBits: {
                        ...
                        if (v < 0 || v > (UInt32)Base.kNumPosStatesBitsEncodingMax)
                            throw new InvalidParamException();
                        this._posStateBits = (int)v;
                        this._posStateMask = ((UInt32)1 << (int)this._posStateBits) - 1;
                        break;
                    }
                    case CoderPropID.LitPosBits: {
                        ...
                        if (v < 0 || v > (UInt32)Base.kNumLitPosStatesBitsEncodingMax)
                            throw new InvalidParamException();
                        this._numLiteralPosStateBits = (int)v;
                        break;
                    }
                    case CoderPropID.LitContextBits: {
                        ...
                        if (v < 0 || v > (UInt32)Base.kNumLitContextBitsMax)
                            throw new InvalidParamException();
                        ;
                        this._numLiteralContextBits = (int)v;
                        break;
                    }
